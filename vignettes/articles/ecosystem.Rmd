...
digraph dag_ecosystem {
  graph [rankdir=TB, bgcolor=transparent, pad=0.05, size=30, fontsize=28,
         ranksep=0.28, nodesep=0.18, splines=true]
  node  [shape=box, style=rounded, fontname=Helvetica,
         fontsize=30, penwidth=1.1, color=\"#455A64\"]
  edge  [color=\"red\", arrowsize=0.9, fontsize=22, fontcolor=\"red\"]
