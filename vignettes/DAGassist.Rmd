---
title: "Introduction to DAGassist"
...
link-citations: true
vignette: >
  %\VignetteIndexEntry{Introduction to DAGassist}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

```{r setup, include = FALSE}
#fix color inverting in dark mode
knitr::opts_chunk$set(
  collapse = TRUE, comment = "#>",
  dev = "png", dev.args = list(bg = "white"), dpi = 150,
...
For the purpose of this guide, we are interested in the total treatment effect.
...
```{r word-excel_report, eval = FALSE}
#word example
DAGassist(dag_model,
          formula = lm(children ~ edu_year + age + class + gender + 
                         immigrant + urban + birth_control + income + 
...
Whereas PDAGs address directional uncertainty in existing edges, a second set of assumptions concerns missing edges. A missing arrow in a DAG encodes a strong null [@HaberEtAl2022]. Because these exclusion assumptions are rarely testable, it is useful to consider whether an estimand would survive their violation.
