...
#>    - Original: children ~ edu_year + age + class + gender + immigrant + urban + contract + pref | 0 | birth_control + income + married + job_stability_t
#>    - Minimal 1: children ~ edu_year + age + class + contract + gender + immigrant + urban | 0 | birth_control + income + married + job_stability_t
#>    - Canonical: children ~ edu_year + age + class + contract + gender + immigrant + pref + urban | 0 | birth_control + income + married + job_stability_t
#> 
#> Model comparison:
#> 
#> +-------------------+-----------+-----------------+-----------+------------------+-----------+------------------+
#> |                   | Original  | Original (ACDE) | Minimal 1 | Minimal 1 (ACDE) | Canonical | Canonical (ACDE) |
#> +===================+===========+=================+===========+==================+===========+==================+
#> | edu_year          | -0.122*** | -0.122***       | -0.080*** | -0.121***        | -0.080*** | -0.122***        |
#> +-------------------+-----------+-----------------+-----------+------------------+-----------+------------------+
#> |                   | (0.015)   | (0.010)         | (0.013)   | (0.010)          | (0.013)   | (0.010)          |
#> +-------------------+-----------+-----------------+-----------+------------------+-----------+------------------+
#> | age               | 0.070***  | 0.070***        | 0.095***  | 0.070***         | 0.096***  | 0.070***         |
#> +-------------------+-----------+-----------------+-----------+------------------+-----------+------------------+
#> |                   | (0.004)   | (0.003)         | (0.003)   | (0.003)          | (0.003)   | (0.003)          |
#> +-------------------+-----------+-----------------+-----------+------------------+-----------+------------------+
#> | genderMale        | 0.181*    | 0.181*          | 0.179*    | 0.171*           | 0.190*    | 0.181*           |
#> +-------------------+-----------+-----------------+-----------+------------------+-----------+------------------+
#> |                   | (0.085)   | (0.085)         | (0.087)   | (0.086)          | (0.085)   | (0.085)          |
#> +-------------------+-----------+-----------------+-----------+------------------+-----------+------------------+
#> | immigrantYes      | -0.246+   | -0.246*         | -0.172    | -0.175           | -0.243+   | -0.246*          |
#> +-------------------+-----------+-----------------+-----------+------------------+-----------+------------------+
#> |                   | (0.128)   | (0.116)         | (0.131)   | (0.118)          | (0.129)   | (0.116)          |
#> +-------------------+-----------+-----------------+-----------+------------------+-----------+------------------+
#> | urbanUrban        | 0.121     | 0.121           | 0.238*    | 0.190*           | 0.175+    | 0.121            |
#> +-------------------+-----------+-----------------+-----------+------------------+-----------+------------------+
#> |                   | (0.094)   | (0.090)         | (0.096)   | (0.092)          | (0.094)   | (0.090)          |
#> +-------------------+-----------+-----------------+-----------+------------------+-----------+------------------+
#> | birth_control     | 0.133     |                 |           |                  |           |                  |
#> +-------------------+-----------+-----------------+-----------+------------------+-----------+------------------+
#> |                   | (0.103)   |                 |           |                  |           |                  |
...
#> |                   | (0.047)   |                 |           |                  |           |                  |
#> +-------------------+-----------+-----------------+-----------+------------------+-----------+------------------+
#> | contractTemporary | 0.710***  | 0.710***        | 0.772***  | 0.685***         | 0.804***  | 0.710***         |
#> +-------------------+-----------+-----------------+-----------+------------------+-----------+------------------+
#> |                   | (0.110)   | (0.102)         | (0.112)   | (0.103)          | (0.110)   | (0.102)          |
#> +-------------------+-----------+-----------------+-----------+------------------+-----------+------------------+
#> | contractPermanent | 0.893***  | 0.893***        | 1.116***  | 0.932***         | 1.093***  | 0.893***         |
#> +-------------------+-----------+-----------------+-----------+------------------+-----------+------------------+
#> |                   | (0.114)   | (0.102)         | (0.113)   | (0.104)          | (0.111)   | (0.102)          |
#> +-------------------+-----------+-----------------+-----------+------------------+-----------+------------------+
#> | pref              | 0.581***  | 0.581***        |           |                  | 0.578***  | 0.581***         |
#> +-------------------+-----------+-----------------+-----------+------------------+-----------+------------------+
