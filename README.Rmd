...
<div class="lead">
An all-in-one DAG-driven robustness check. Classify variables by causal role, compute
the smallest and largest permissible back-door adjustment sets, and compare the significance of models.
</div>
