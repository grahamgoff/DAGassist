...
#> Minimal controls 1: {F, H}
#> Minimal controls 2: {C, F}
#> Minimal controls 3: {A, B, H}
#> Minimal controls 4: {A, B, C}
#> Canonical controls: {A, B, C, F, G, H}
#> 
#> Formulas:
#>   original:  Y ~ D + G + H + F + A + B + C
#> 
#> Model comparison:
#> 
#> +---+----------+-----------+-----------+-----------+-----------+-----------+---------------+
#> |   | Original | Minimal 1 | Minimal 2 | Minimal 3 | Minimal 4 | Canonical | Canon. (-NCT) |
#> +===+==========+===========+===========+===========+===========+===========+===============+
#> | D | 1.034*** | 0.977***  | 0.969***  | 1.038***  | 1.024***  | 1.034***  | 1.034***      |
#> +---+----------+-----------+-----------+-----------+-----------+-----------+---------------+
#> |   | (0.032)  | (0.020)   | (0.023)   | (0.036)   | (0.041)   | (0.032)   | (0.032)       |
#> +---+----------+-----------+-----------+-----------+-----------+-----------+---------------+
#> | G | 0.397*** |           |           |           |           | 0.397***  | 0.397***      |
#> +---+----------+-----------+-----------+-----------+-----------+-----------+---------------+
#> |   | (0.032)  |           |           |           |           | (0.032)   | (0.032)       |
#> +---+----------+-----------+-----------+-----------+-----------+-----------+---------------+
#> | H | 0.486*** | 0.522***  |           | 0.495***  |           | 0.486***  | 0.486***      |
#> +---+----------+-----------+-----------+-----------+-----------+-----------+---------------+
#> |   | (0.032)  | (0.028)   |           | (0.031)   |           | (0.032)   | (0.032)       |
#> +---+----------+-----------+-----------+-----------+-----------+-----------+---------------+
#> | F | 0.618*** | 0.606***  | 0.593***  |           |           | 0.618***  | 0.618***      |
#> +---+----------+-----------+-----------+-----------+-----------+-----------+---------------+
#> |   | (0.037)  | (0.036)   | (0.040)   |           |           | (0.037)   | (0.037)       |
#> +---+----------+-----------+-----------+-----------+-----------+-----------+---------------+
#> | A | -0.111** |           |           | 0.158***  | 0.169***  | -0.111**  | -0.111**      |
#> +---+----------+-----------+-----------+-----------+-----------+-----------+---------------+
#> |   | (0.043)  |           |           | (0.047)   | (0.051)   | (0.043)   | (0.043)       |
#> +---+----------+-----------+-----------+-----------+-----------+-----------+---------------+
#> | B | -0.008   |           |           | -0.161*** | -0.162*** | -0.008    | -0.008        |
#> +---+----------+-----------+-----------+-----------+-----------+-----------+---------------+
#> |   | (0.039)  |           |           | (0.045)   | (0.049)   | (0.039)   | (0.039)       |
#> +---+----------+-----------+-----------+-----------+-----------+-----------+---------------+
#> | C | 0.037    |           | 0.420***  |           | 0.391***  | 0.037     | 0.037         |
#> +---+----------+-----------+-----------+-----------+-----------+-----------+---------------+
#> |   | (0.042)  |           | (0.040)   |           | (0.045)   | (0.042)   | (0.042)       |
#> +===+==========+===========+===========+===========+===========+===========+===============+
