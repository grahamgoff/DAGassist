...
#> 
#> +----------+-----------+-----------+-------------------+-----------+-------------+------------------+-------------------+
#> |          | Original  | Minimal 1 | Minimal 1 (TOTAL) | Canonical | Raw (SACDE) | Weighted (SACDE) | Canonical (TOTAL) |
#> +==========+===========+===========+===================+===========+=============+==================+===================+
#> | X        | 0.452***  | 1.256***  | 1.084***          | 1.256***  | 0.719***    | 0.620***         | 1.097***          |
#> +----------+-----------+-----------+-------------------+-----------+-------------+------------------+-------------------+
#> |          | (0.032)   | (0.027)   | (0.018)           | (0.026)   | (0.023)     | (0.037)          | (0.018)           |
#> +----------+-----------+-----------+-------------------+-----------+-------------+------------------+-------------------+
#> | M        | 0.514***  |           |                   |           |             |                  |                   |
#> +----------+-----------+-----------+-------------------+-----------+-------------+------------------+-------------------+
#> |          | (0.021)   |           |                   |           |             |                  |                   |
...
#>   Minimal 1 (TOTAL): w range=0.024..371.8 | ESS (weighted)=56.15 [LOW_ESS,EXTREME_W]
#>   Canonical (TOTAL): w range=0.02283..339.7 | ESS (weighted)=64.48 [LOW_ESS,EXTREME_W]
#> 
